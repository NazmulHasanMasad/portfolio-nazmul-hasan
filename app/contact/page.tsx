  ...
  return (
    <div className="w-full">
      ...
      <Grid colCount={12} className="mt-10">
        <MotionDiv src="/images/ai_image_1.png" className="col-span-4 hidden md:flex" isTransparentBG isRoundedImage/>
        <MotionDiv src="/images/ai_image_1.png" className="col-span-12 md:hidden flex flex-row items-center justify-center" isTransparentBG isRoundedImage height_width={200}/>
        <Flex
          direction="col"
